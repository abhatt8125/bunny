...
emptyS=loadAnimation("empty.png")
starOne=loadAnimation("one_star.png")
starTwo=loadAnimation("stars.png")
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   air=createImg('baloon2.png')
   air.position(260,370)
    air.size(120,120)
    air.mouseClicked(airB)
  ...
  starD=createSprite(70,40,30,30)
  starD.scale=0.2
  starD.addAnimation("empty",emptyS)
  starD.addAnimation("one",starOne)
  starD.addAnimation("Two",starTwo)
...
function draw() 
{
  ...
  starD.changeAnimation("one")
   ...
   if(star.visible==true && star2.visible==false){
     starD.changeAnimation("one")
   }  
